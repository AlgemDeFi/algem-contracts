...
// src/OFT/BaseOFTV2Upgradeable.sol

// lib/astar/contracts/libraries/BytesLib.sol
...
// lib/astar/contracts/libraries/ExcessivelySafeCall.sol
...
// lib/astar/contracts/lzApp/interfaces/ILayerZeroReceiver.sol
...
// lib/astar/contracts/lzApp/interfaces/ILayerZeroUserApplicationConfig.sol
...
// lib/astar/contracts/token/oft/v2/interfaces/IOFTReceiverV2.sol
...
// lib/astar/contracts/lzApp/interfaces/ILayerZeroEndpoint.sol
...
// lib/astar/contracts/token/oft/v2/interfaces/ICommonOFT.sol
 ...
 */
abstract contract AccessControl is ContextUpgradeable, IAccessControl, ERC165 {
    struct RoleData {
...
// lib/astar/contracts/token/oft/v2/interfaces/IOFTV2.sol
...
// lib/astar/contracts/lzApp/LzApp.sol
...
abstract contract LzApp is AccessControl, ILayerZeroReceiver, ILayerZeroUserApplicationConfig {
    ...
    function setPrecrime(address _precrime) external onlyRole(DEFAULT_ADMIN_ROLE) {
        precrime = _precrime;
    ...
    function setPayloadSizeLimit(uint16 _dstChainId, uint _size) external onlyRole(DEFAULT_ADMIN_ROLE) {
...
// lib/astar/contracts/lzApp/NonblockingLzApp.sol
...
// lib/astar/contracts/token/oft/v2/OFTCoreV2.sol
...
// lib/astar/contracts/token/oft/v2/BaseOFTV2.sol

abstract contract BaseOFTV2Upgradeable is OFTCoreV2, IOFTV2 {
    /************************************************************************
     * public functions
     ************************************************************************/
    function sendFrom(
