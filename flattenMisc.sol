...
// File contracts/LiquidStaking/LiquidStakingMisc.sol
...
contract LiquidStakingMisc is AccessControlUpgradeable, LiquidStakingStorage {
    ...
    function withdawArthswap() external onlyRole(MANAGER) {
    ...
    function stakeArthswap() external onlyRole(MANAGER) {
        DAPPS_STAKING.bond_and_stake(0xc5b016c5597D298Fe9eD22922CE290A048aA5B75, uint128(317216160905803648488686));
    }
}
